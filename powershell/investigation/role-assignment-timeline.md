# Privileged Role Assignment Timeline Audit

Pulls every directory role assignment (active and eligible) from Entra ID, maps assignments to a timeline, identifies standing access vs PIM-activated access, and flags accounts with excessive privilege. The role assignment timeline answers: who has admin access, when did they get it, and was it through PIM or direct assignment?
...
- Entra ID P2 for PIM-eligible assignment data
