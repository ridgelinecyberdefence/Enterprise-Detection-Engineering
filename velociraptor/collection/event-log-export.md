...
- [Windows Forensics — Event Log Analysis](https://training.ridgelinecyber.com/courses/windows-forensics/) — Event ID reference and log analysis methodology
- [Incident Response — Evidence Collection](https://training.ridgelinecyber.com/courses/practical-incident-response/) — targeted log collection procedures
- [Velociraptor — EVTX Parsing](https://training.ridgelinecyber.com/short-courses/velociraptor/) — VQL event log queries
